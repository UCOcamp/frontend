    ...
    <div>
      ...
      <main>
        <div className="hero">
          ...
          <br></br>
          <button className='loginButton'><Link href="/courses-707f4c1e-389f-4909-8922-70dfc550081b-lessons-69ad1b6b-82e2-408a-b6bc-fd896485e8d9-lesson-6">&nbsp;&nbsp;&nbsp;Siguiente lección&nbsp;&nbsp;&nbsp;</Link></button>
        </div>
      </main>
      <Footer/>
    </div>
